...
public class DictConstants {
  ...
  public static final String BOOKING_PERIOD = "BOOKING_PERIOD";
  public static final String NAVIGATOR_TYPE = "NAVIGATOR_TYPE";
  public static final String ORDER_TYPE = "ORDER_TYPE";
  public static final String CHARGING_TYPE = "CHARGING_TYPE";
  public static final String BOOKING_ORDER_STATUS = "BOOKING_ORDER_STATUS";
  ...
  public enum BookingPeriod{
        HALF(0, "半小时", "HALF", 1015, "预约时间段间隔", "BOOKING_PERIOD", 0),
        ONE(1, "一小时", "ONE", 1015, "预约时间段间隔", "BOOKING_PERIOD", 0),
        TWO(2, "两小时", "TWO", 1015, "预约时间段间隔", "BOOKING_PERIOD", 0),
        FOUR(3, "四小时", "FOUR", 1015, "预约时间段间隔", "BOOKING_PERIOD", 0),
        EIGHT(4, "八小时", "EIGHT", 1015, "预约时间段间隔", "BOOKING_PERIOD", 0),
        TWELVE(5, "十二小时", "TWELVE", 1015, "预约时间段间隔", "BOOKING_PERIOD", 0),
        TWENTY_FOUR(6, "二十四小时", "TWENTY_FOUR", 1015, "预约时间段间隔", "BOOKING_PERIOD", 0),
  ;
  final int keyId;
  final String keyName;
  final String keyEnName;
  ...
  public enum OrderType{
        BOOKING_ORDER(1, "预约订单", "BOOKING_ORDER", 1012, "订单类型", "ORDER_TYPE", 0),
  ...
  public enum ChargingType{
        PERIOD(0, "按时间段", "PERIOD", 1014, "计费方式", "CHARGING_TYPE", 0),
        SESSION(1, "按场次", "SESSION", 1014, "计费方式", "CHARGING_TYPE", 0),
  ;
  final int keyId;
  final String keyName;
  final String keyEnName;
  ...
  public enum BookingOrderStatus{
        TO_BE_PAID(0, "待支付", "TO_BE_PAID", 1016, "预约订单状态", "BOOKING_ORDER_STATUS", 0),
        TO_BE_USED(1, "待进店", "TO_BE_USED", 1016, "预约订单状态", "BOOKING_ORDER_STATUS", 0),
        TO_BE_CONFIRMED(2, "待确认", "TO_BE_CONFIRMED", 1016, "预约订单状态", "BOOKING_ORDER_STATUS", 0),
        FINISHED(3, "已完成", "FINISHED", 1016, "预约订单状态", "BOOKING_ORDER_STATUS", 0),
        CLOSED(4, "已关闭", "CLOSED", 1016, "预约订单状态", "BOOKING_ORDER_STATUS", 0),
        REFUNDED(5, "已退款", "REFUNDED", 1016, "预约订单状态", "BOOKING_ORDER_STATUS", 0),
  ;
  final int keyId;
  final String keyName;
  final String keyEnName;
